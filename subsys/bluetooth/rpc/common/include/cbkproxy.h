 ...
 *
 * @param handler_name  name of the handler fucntion that can ne passed to @ref
 ...
 *                      parameres.
 */
#define CBKPROXY_HANDLER(...) _CBKPROXY_HANDLER_CAT(_CBKPROXY_HANDLER_, _CBKPROXY_HANDLER_CNT(__VA_ARGS__)) (__VA_ARGS__)
#define _CBKPROXY_HANDLER_CNT2(a, b, c, d, e, f, ...) f
#define _CBKPROXY_HANDLER_CNT(...) _CBKPROXY_HANDLER_CNT2(__VA_ARGS__, RET_PARAM, VOID_PARAM, RET_VOID, VOID_VOID)
#define _CBKPROXY_HANDLER_CAT2(a, b) a ## b
#define _CBKPROXY_HANDLER_CAT(a, b) _CBKPROXY_HANDLER_CAT2(a, b)
#define _CBKPROXY_HANDLER_PAR1(...) uint32_t callback_slot, uint32_t _rsv0, uint32_t _rsv1, uint32_t _ret, __VA_ARGS__
