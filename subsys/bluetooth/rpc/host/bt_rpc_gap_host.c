...
static void bt_rpc_get_check_list_rpc_handler(CborValue *_value, void *_handler_data)/*####%BvoP*/
{                                                                                    /*#####@Dcc*/
	...
	size = ser_decode_uint(_value);                                              /*####%Ch9I*/
	data = ser_scratchpad_add(&_scratchpad, sizeof(uint8_t) * size);             /*#####@Hy0*/

	if (!ser_decoding_done_and_check(_value)) {                                  /*######%FE*/
		goto decoding_error;                                                 /*######QTM*/
	}                                                                            /*######@1Y*/

	bt_rpc_get_check_list(data, size);                                           /*##DvuUsMA*/
	...
	return;                                                                      /*######%FW*/
decoding_error:                                                                      /*#######DB*/
	report_decoding_error(BT_RPC_GET_CHECK_LIST_RPC_CMD, _handler_data);         /*#######Fi*/
	SER_SCRATCHPAD_FREE(&_scratchpad);                                           /*#######@4*/

}                                                                                    /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_rpc_get_check_list, BT_RPC_GET_CHECK_LIST_RPC_CMD,/*####%BsRB*/
	bt_rpc_get_check_list_rpc_handler, NULL);                                         /*#####@Efg*/
					  ...
					  uint32_t callback_slot)
{
	...
	ser_encode_int(&_ctx.encoder, err);                                      /*####%A026*/
	ser_encode_callback_call(&_ctx.encoder, callback_slot);                  /*#####@s8k*/
...
{                                                                                /*#####@EdU*/
	...
	name = ser_decode_str_into_scratchpad(&_scratchpad);                     /*##CuZfPfw*/
...
{                                                                                /*#####@Q0A*/
	...
	name = ser_scratchpad_add(&_scratchpad, size);                           /*##D8/7WMc*/
...
{                                                                                      /*#####@m9Q*/
	...
	*count = ser_decode_uint(_value);                                              /*##CgKRZw4*/
	...
	addrs = ser_scratchpad_add(&_scratchpad, *count * sizeof(bt_addr_le_t));       /*##DyaxqSw*/
...
{                                                                                /*#####@/TY*/
	...
	addr = ser_decode_buffer(_value, &_addr_data, sizeof(bt_addr_le_t));     /*####%ChfS*/
	irk = ser_decode_buffer_into_scratchpad(&_scratchpad);                   /*#####@v8U*/
...
{                                                                                /*#####@SEk*/
	...
	id = ser_decode_uint(_value);                                            /*######%Cr*/
	addr = ser_decode_buffer(_value, &_addr_data, sizeof(bt_addr_le_t));     /*######eNy*/
	irk = ser_decode_buffer_into_scratchpad(&_scratchpad);                   /*######@Ek*/
...
{                                                                                /*#####@+3g*/
	...
	_data->type = ser_decode_uint(_value);                                   /*######%Co*/
	_data->data_len = ser_decode_uint(_value);                               /*######RRs*/
	_data->data = ser_decode_buffer_into_scratchpad(_scratchpad);            /*######@ek*/
					    ...
					    uint32_t callback_slot)
{
	...
	ser_encode_int(&_ctx.encoder, rssi);                                     /*#######4l*/
	ser_encode_uint(&_ctx.encoder, adv_type);                                /*#######C6*/
	net_buf_simple_enc(&_ctx.encoder, buf);                                  /*#######A0*/
	ser_encode_callback_call(&_ctx.encoder, callback_slot);                  /*########@*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, BT_LE_SCAN_CB_T_CALLBACK_RPC_CMD,   /*####%BJi/*/
		&_ctx, ser_rsp_decode_void, NULL);                               /*#####@j+I*/
}
...
{                                                                                          /*#####@MEU*/
	...
	_data->sid = ser_decode_uint(_value);                                              /*#######nx*/
	_data->secondary_max_skip = ser_decode_uint(_value);                               /*########i*/
	_data->options = ser_decode_uint(_value);                                          /*########h*/
	_data->interval_min = ser_decode_uint(_value);                                     /*########r*/
...
{                                                                                /*#####@+8A*/
	...
	ad = ser_scratchpad_add(&_scratchpad, ad_len * sizeof(struct bt_data));  /*########g*/
	if (ad == NULL) {                                                        /*########8*/
		goto decoding_error;                                             /*########i*/
	}                                                                        /*########D*/
	for (_i = 0; _i < ad_len; _i++) {                                        /*########f*/
		bt_data_dec(&_scratchpad, &ad[_i]);                              /*########Q*/
	}                                                                        /*#########*/
...
{                                                                                    /*#####@rwo*/
	...
	ad = ser_scratchpad_add(&_scratchpad, ad_len * sizeof(struct bt_data));      /*########C*/
	if (ad == NULL) {                                                            /*########t*/
		goto decoding_error;                                                 /*########m*/
	}                                                                            /*########Z*/
	for (_i = 0; _i < ad_len; _i++) {                                            /*########a*/
		bt_data_dec(&_scratchpad, &ad[_i]);                                  /*########r*/
	}                                                                            /*########U*/
	sd_len = ser_decode_uint(_value);                                            /*#########*/
	sd = ser_scratchpad_add(&_scratchpad, sd_len * sizeof(struct bt_data));      /*#########*/
	if (sd == NULL) {                                                            /*#########*/
...
{                                                                                                             /*#####@F68*/
	...
	bt_rpc_encode_bt_conn(_encoder, _data->conn);                                                         /*##AwB0RHo*/
				    ...
				    uint32_t callback_slot)
{
	...
	ser_encode_uint(&_ctx.encoder, (uintptr_t)adv);                             /*######%A0*/
	bt_le_ext_adv_sent_info_enc(&_ctx.encoder, info);                           /*######W5k*/
	ser_encode_callback_call(&_ctx.encoder, callback_slot);                     /*######@Hk*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, BT_LE_EXT_ADV_CB_SENT_CALLBACK_RPC_CMD,/*####%BBCI*/
		&_ctx, ser_rsp_decode_void, NULL);                                  /*#####@ch8*/
}
				    ...
				    uint32_t callback_slot)
{
	...
	bt_le_ext_adv_connected_info_enc(&_ctx.encoder, info);                           /*######UBI*/
	ser_encode_callback_call(&_ctx.encoder, callback_slot);                          /*######@2Q*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, BT_LE_EXT_ADV_CB_CONNECTED_CALLBACK_RPC_CMD,/*####%BClr*/
		&_ctx, ser_rsp_decode_void, NULL);                                       /*#####@j6o*/
}
				       ...
				       uint32_t callback_slot)
{
	...
	ser_encode_uint(&_ctx.encoder, (uintptr_t)adv);                                /*######%A/*/
	bt_le_ext_adv_scanned_info_enc(&_ctx.encoder, info);                           /*######WZb*/
	ser_encode_callback_call(&_ctx.encoder, callback_slot);                        /*######@cU*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, BT_LE_EXT_ADV_CB_SCANNED_CALLBACK_RPC_CMD,/*####%BMPq*/
		&_ctx, ser_rsp_decode_void, NULL);                                     /*#####@nug*/
}
...
{                                                                                     /*#####@uhw*/
	...
	ad_len = ser_decode_uint(_value);                                             /*########C*/
	ad = ser_scratchpad_add(&_scratchpad, ad_len * sizeof(struct bt_data));       /*########u*/
	if (ad == NULL) {                                                             /*########4*/
		goto decoding_error;                                                  /*########5*/
	}                                                                             /*########K*/
	for (_i = 0; _i < ad_len; _i++) {                                             /*########G*/
			...
			struct net_buf_simple *buf)
{
	...
	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, BT_LE_SCAN_CB_RECV_RPC_CMD,         /*####%BMSI*/
		&_ctx, ser_rsp_decode_void, NULL);                               /*#####@7TI*/
}
...
void bt_le_scan_cb_timeout(void)
{
	...
	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, BT_LE_SCAN_CB_TIMEOUT_RPC_CMD,      /*####%BH8w*/
		&_ctx, ser_rsp_decode_void, NULL);                               /*#####@jYA*/
}
...
{                                                                                 /*#####@46c*/
	...
	chan_map = ser_decode_buffer_into_scratchpad(&_scratchpad);               /*##CsuUht0*/
					       ...
					       uint32_t callback_slot)
{
	...
	bt_bond_info_enc(&_ctx.encoder, info);                                   /*######%A7*/
	ser_encode_uint(&_ctx.encoder, (uintptr_t)user_data);                    /*######Rha*/
	ser_encode_callback_call(&_ctx.encoder, callback_slot);                  /*######@YY*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, BT_FOREACH_BOND_CB_CALLBACK_RPC_CMD,/*####%BOCl*/
		&_ctx, ser_rsp_decode_void, NULL);                               /*#####@Y7M*/
}
...
static void bt_le_per_adv_list_clear_rpc_handler(CborValue *_value, void *_handler_data)/*####%BoSc*/
{                                                                                       /*#####@gKw*/
	...
	_result = bt_le_per_adv_list_clear();                                           /*##Dl7gRq0*/

	ser_rsp_send_int(_result);                                                      /*##BPC96+4*/

}                                                                                       /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_list_clear, BT_LE_PER_ADV_LIST_CLEAR_RPC_CMD,/*####%BlZp*/
	bt_le_per_adv_list_clear_rpc_handler, NULL);                                            /*#####@fno*/

static void bt_le_per_adv_list_add_rpc_handler(CborValue *_value, void *_handler_data)/*####%BmyR*/
{                                                                                     /*#####@d44*/

	bt_addr_le_t _addr_data;                                                      /*######%AV*/
	const bt_addr_le_t * addr;                                                    /*#######vC*/
	uint8_t sid;                                                                  /*#######xz*/
	int _result;                                                                  /*#######@c*/

	addr = ser_decode_buffer(_value, &_addr_data, sizeof(bt_addr_le_t));          /*####%CmqR*/
	sid = ser_decode_uint(_value);                                                /*#####@IRY*/

	if (!ser_decoding_done_and_check(_value)) {                                   /*######%FE*/
		goto decoding_error;                                                  /*######QTM*/
	}                                                                             /*######@1Y*/

	_result = bt_le_per_adv_list_add(addr, sid);                                  /*##DgRaqZc*/

	ser_rsp_send_int(_result);                                                    /*##BPC96+4*/

	return;                                                                       /*######%Fe*/
decoding_error:                                                                       /*######arV*/
	report_decoding_error(BT_LE_PER_ADV_LIST_ADD_RPC_CMD, _handler_data);         /*######@xA*/

}                                                                                     /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_list_add, BT_LE_PER_ADV_LIST_ADD_RPC_CMD,/*####%BigA*/
	bt_le_per_adv_list_add_rpc_handler, NULL);                                          /*#####@nYc*/

static void bt_le_per_adv_list_remove_rpc_handler(CborValue *_value, void *_handler_data)/*####%BhMr*/
{                                                                                        /*#####@BCk*/
	...
	_result = bt_le_per_adv_list_remove(addr, sid);                                  /*##DhaHKis*/

	ser_rsp_send_int(_result);                                                       /*##BPC96+4*/

	return;                                                                          /*######%FQ*/
decoding_error:                                                                          /*######BuF*/
	report_decoding_error(BT_LE_PER_ADV_LIST_REMOVE_RPC_CMD, _handler_data);         /*######@Wo*/

}                                                                                        /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_list_remove, BT_LE_PER_ADV_LIST_REMOVE_RPC_CMD,/*####%BuXn*/
	bt_le_per_adv_list_remove_rpc_handler, NULL);                                             /*#####@vI0*/

void bt_le_per_adv_param_dec(CborValue *_value, struct bt_le_per_adv_param *_data)/*####%Bsly*/
{                                                                                 /*#####@Yog*/

	_data->interval_min = ser_decode_uint(_value);                            /*######%Ch*/
	_data->interval_max = ser_decode_uint(_value);                            /*######2LO*/
	_data->options = ser_decode_uint(_value);                                 /*######@fU*/

}                                                                                 /*##B9ELNqo*/

static void bt_le_per_adv_set_param_rpc_handler(CborValue *_value, void *_handler_data)/*####%BhbV*/
{                                                                                      /*#####@3vo*/

	struct bt_le_ext_adv * adv;                                                    /*######%Ac*/
	struct bt_le_per_adv_param param;                                              /*######/cH*/
	int _result;                                                                   /*######@Ng*/

	adv = (struct bt_le_ext_adv *)ser_decode_uint(_value);                         /*####%Cjyg*/
	bt_le_per_adv_param_dec(_value, &param);                                       /*#####@p/s*/

	if (!ser_decoding_done_and_check(_value)) {                                    /*######%FE*/
		goto decoding_error;                                                   /*######QTM*/
	}                                                                              /*######@1Y*/

	_result = bt_le_per_adv_set_param(adv, &param);                                /*##DlhIeJ8*/

	ser_rsp_send_int(_result);                                                     /*##BPC96+4*/

	return;                                                                        /*######%FR*/
decoding_error:                                                                        /*######yza*/
	report_decoding_error(BT_LE_PER_ADV_SET_PARAM_RPC_CMD, _handler_data);         /*######@D4*/

}                                                                                      /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_set_param, BT_LE_PER_ADV_SET_PARAM_RPC_CMD,/*####%BvHj*/
	bt_le_per_adv_set_param_rpc_handler, NULL);                                           /*#####@C50*/

static void bt_le_per_adv_set_data_rpc_handler(CborValue *_value, void *_handler_data)/*####%Biux*/
{                                                                                     /*#####@ztA*/

	const struct bt_le_ext_adv * adv;                                             /*#######%A*/
	size_t ad_len;                                                                /*#######e1*/
	struct bt_data * ad;                                                          /*#######U0*/
	int _result;                                                                  /*########G*/
	...
	ad_len = ser_decode_uint(_value);                                             /*########C*/
	ad = ser_scratchpad_add(&_scratchpad, ad_len * sizeof(struct bt_data));       /*########j*/
	if (ad == NULL) {                                                             /*########w*/
		goto decoding_error;                                                  /*########C*/
	}                                                                             /*########v*/
	for (_i = 0; _i < ad_len; _i++) {                                             /*########9*/
	...
	_result = bt_le_per_adv_set_data(adv, ad, ad_len);                            /*##Dm6b3zA*/
	...
	return;                                                                       /*######%FU*/
decoding_error:                                                                       /*#######Ln*/
	report_decoding_error(BT_LE_PER_ADV_SET_DATA_RPC_CMD, _handler_data);         /*#######jB*/
	SER_SCRATCHPAD_FREE(&_scratchpad);                                            /*#######@U*/

}                                                                                     /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_set_data, BT_LE_PER_ADV_SET_DATA_RPC_CMD,/*####%BgCJ*/
	bt_le_per_adv_set_data_rpc_handler, NULL);                                          /*#####@vms*/

static void bt_le_per_adv_start_rpc_handler(CborValue *_value, void *_handler_data)/*####%Bi1e*/
{                                                                                  /*#####@hok*/
	...
	_result = bt_le_per_adv_start(adv);                                        /*##DhoXVTg*/

	ser_rsp_send_int(_result);                                                 /*##BPC96+4*/

	return;                                                                    /*######%Fe*/
decoding_error:                                                                    /*######qtx*/
	report_decoding_error(BT_LE_PER_ADV_START_RPC_CMD, _handler_data);         /*######@Os*/

}                                                                                  /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_start, BT_LE_PER_ADV_START_RPC_CMD,/*####%Bgr2*/
	bt_le_per_adv_start_rpc_handler, NULL);                                       /*#####@+PQ*/

static void bt_le_per_adv_stop_rpc_handler(CborValue *_value, void *_handler_data)/*####%BhWo*/
{                                                                                 /*#####@vkA*/
	...
	_result = bt_le_per_adv_stop(adv);                                        /*##DnyDBu8*/

	ser_rsp_send_int(_result);                                                /*##BPC96+4*/

	return;                                                                   /*######%Ff*/
decoding_error:                                                                   /*######/ho*/
	report_decoding_error(BT_LE_PER_ADV_STOP_RPC_CMD, _handler_data);         /*######@/o*/

}                                                                                 /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_stop, BT_LE_PER_ADV_STOP_RPC_CMD,/*####%Bquj*/
	bt_le_per_adv_stop_rpc_handler, NULL);                                      /*#####@gqk*/

#if defined(CONFIG_BT_CONN) || defined(__GENERATOR)
static void bt_le_per_adv_set_info_transfer_rpc_handler(CborValue *_value, void *_handler_data)/*####%Bp31*/
{                                                                                              /*#####@Hhc*/

	const struct bt_le_ext_adv * adv;                                                      /*######%Aa*/
	const struct bt_conn * conn;                                                           /*#######1U*/
	uint16_t service_data;                                                                 /*#######JL*/
	int _result;                                                                           /*#######@w*/

	adv = (const struct bt_le_ext_adv *)ser_decode_uint(_value);                           /*######%Cp*/
	conn = bt_rpc_decode_bt_conn(_value);                                                  /*######IbH*/
	service_data = ser_decode_uint(_value);                                                /*######@AI*/

	if (!ser_decoding_done_and_check(_value)) {                                            /*######%FE*/
		goto decoding_error;                                                           /*######QTM*/
	}                                                                                      /*######@1Y*/

	_result = bt_le_per_adv_set_info_transfer(adv, conn, service_data);                    /*##DlCODPY*/

	ser_rsp_send_int(_result);                                                             /*##BPC96+4*/

	return;                                                                                /*######%FV*/
decoding_error:                                                                                /*######KQl*/
	report_decoding_error(BT_LE_PER_ADV_SET_INFO_TRANSFER_RPC_CMD, _handler_data);         /*######@zw*/

}                                                                                              /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_set_info_transfer, BT_LE_PER_ADV_SET_INFO_TRANSFER_RPC_CMD,/*####%Bklh*/
	bt_le_per_adv_set_info_transfer_rpc_handler, NULL);                                                   /*#####@NTU*/
#endif /* defined(CONFIG_BT_CONN) || defined(__GENERATOR) */
#endif /* defined(CONFIG_BT_PER_ADV) || defined(__GENERATOR) */

#if defined(CONFIG_BT_PER_ADV_SYNC) || defined(__GENERATOR)
static void bt_le_per_adv_sync_get_index_rpc_handler(CborValue *_value, void *_handler_data)/*####%BsyO*/
{                                                                                           /*#####@IYQ*/

	struct bt_le_per_adv_sync * per_adv_sync;                                           /*####%Adso*/
	uint8_t _result;                                                                    /*#####@gPc*/

	per_adv_sync = (struct bt_le_per_adv_sync *)ser_decode_uint(_value);                /*##Cl5bAwQ*/

	if (!ser_decoding_done_and_check(_value)) {                                         /*######%FE*/
		goto decoding_error;                                                        /*######QTM*/
	}                                                                                   /*######@1Y*/

	_result = bt_le_per_adv_sync_get_index(per_adv_sync);                               /*##Do2VLkc*/

	ser_rsp_send_uint(_result);                                                         /*##BJsBF7s*/

	return;                                                                             /*######%Fb*/
decoding_error:                                                                             /*######oN8*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_GET_INDEX_RPC_CMD, _handler_data);         /*######@8w*/

}                                                                                           /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_get_index, BT_LE_PER_ADV_SYNC_GET_INDEX_RPC_CMD,/*####%BklQ*/
	bt_le_per_adv_sync_get_index_rpc_handler, NULL);                                                /*#####@ENE*/

void bt_le_per_adv_sync_param_dec(CborValue *_value, struct bt_le_per_adv_sync_param *_data)/*####%Bk5/*/
{                                                                                           /*#####@Oko*/

	ser_decode_buffer(_value, &_data->addr, sizeof(bt_addr_le_t));                      /*#######%C*/
	_data->sid = ser_decode_uint(_value);                                               /*#######m5*/
	_data->options = ser_decode_uint(_value);                                           /*#######47*/
	_data->skip = ser_decode_uint(_value);                                              /*#######ds*/
	_data->timeout = ser_decode_uint(_value);                                           /*########@*/

}                                                                                           /*##B9ELNqo*/

static void bt_le_per_adv_sync_create_rpc_handler(CborValue *_value, void *_handler_data)/*####%Bj/0*/
{                                                                                        /*#####@hG0*/

	struct nrf_rpc_cbor_ctx _ctx;                                                    /*#######%A*/
	int _result;                                                                     /*#######Qb*/
	struct bt_le_per_adv_sync_param param;                                           /*#######eZ*/
	struct bt_le_per_adv_sync *_out_sync_data;                                       /*########Z*/
	struct bt_le_per_adv_sync ** out_sync = &_out_sync_data;                         /*########s*/
	size_t _buffer_size_max = 10;                                                    /*########@*/

	bt_le_per_adv_sync_param_dec(_value, &param);                                    /*##CrQY+94*/

	if (!ser_decoding_done_and_check(_value)) {                                      /*######%FE*/
		goto decoding_error;                                                     /*######QTM*/
	}                                                                                /*######@1Y*/

	_result = bt_le_per_adv_sync_create(&param, out_sync);                           /*##Dt+RWDw*/

	{                                                                                /*####%AnG1*/
		NRF_RPC_CBOR_ALLOC(_ctx, _buffer_size_max);                              /*#####@zxs*/

		ser_encode_int(&_ctx.encoder, _result);                                  /*####%DA6u*/
		ser_encode_uint(&_ctx.encoder, (uintptr_t)(*out_sync));                  /*#####@5qo*/
	...
	return;                                                                          /*######%Fa*/
decoding_error:                                                                          /*######qrO*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_CREATE_RPC_CMD, _handler_data);         /*######@Ag*/

}                                                                                        /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_create, BT_LE_PER_ADV_SYNC_CREATE_RPC_CMD,/*####%BmBP*/
	bt_le_per_adv_sync_create_rpc_handler, NULL);                                             /*#####@K7k*/

static void bt_le_per_adv_sync_delete_rpc_handler(CborValue *_value, void *_handler_data)/*####%BuSU*/
{                                                                                        /*#####@nlA*/

	struct bt_le_per_adv_sync * per_adv_sync;                                        /*####%AXA2*/
	int _result;                                                                     /*#####@FOo*/
	...
	_result = bt_le_per_adv_sync_delete(per_adv_sync);                               /*##Diu/AIE*/

	ser_rsp_send_int(_result);                                                       /*##BPC96+4*/

	return;                                                                          /*######%FT*/
decoding_error:                                                                          /*######o8Z*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_DELETE_RPC_CMD, _handler_data);         /*######@Fw*/

}                                                                                        /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_delete, BT_LE_PER_ADV_SYNC_DELETE_RPC_CMD,/*####%ButM*/
	bt_le_per_adv_sync_delete_rpc_handler, NULL);                                             /*#####@93Y*/

static void bt_le_per_adv_sync_recv_enable_rpc_handler(CborValue *_value, void *_handler_data)/*####%BuQy*/
{                                                                                             /*#####@/rc*/
	...
	_result = bt_le_per_adv_sync_recv_enable(per_adv_sync);                               /*##Dovnexk*/

	ser_rsp_send_int(_result);                                                            /*##BPC96+4*/

	return;                                                                               /*######%FZ*/
decoding_error:                                                                               /*######gAI*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_RECV_ENABLE_RPC_CMD, _handler_data);         /*######@q4*/

}                                                                                             /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_recv_enable, BT_LE_PER_ADV_SYNC_RECV_ENABLE_RPC_CMD,/*####%Bj5m*/
	bt_le_per_adv_sync_recv_enable_rpc_handler, NULL);                                                  /*#####@Xa8*/

static void bt_le_per_adv_sync_recv_disable_rpc_handler(CborValue *_value, void *_handler_data)/*####%Br+M*/
{                                                                                              /*#####@nUo*/
	...
	_result = bt_le_per_adv_sync_recv_disable(per_adv_sync);                               /*##DnxY14k*/

	ser_rsp_send_int(_result);                                                             /*##BPC96+4*/

	return;                                                                                /*######%Fe*/
decoding_error:                                                                                /*######kKI*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_RECV_DISABLE_RPC_CMD, _handler_data);         /*######@V4*/

}                                                                                              /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_recv_disable, BT_LE_PER_ADV_SYNC_RECV_DISABLE_RPC_CMD,/*####%BpLC*/
	bt_le_per_adv_sync_recv_disable_rpc_handler, NULL);                                                   /*#####@Mok*/

#if defined(CONFIG_BT_CONN) || defined(__GENERATOR)
static void bt_le_per_adv_sync_transfer_rpc_handler(CborValue *_value, void *_handler_data)/*####%Brmb*/
{                                                                                          /*#####@Ok8*/

	const struct bt_le_per_adv_sync * per_adv_sync;                                    /*######%AZ*/
	const struct bt_conn * conn;                                                       /*#######98*/
	uint16_t service_data;                                                             /*#######t7*/
	int _result;                                                                       /*#######@w*/

	per_adv_sync = (const struct bt_le_per_adv_sync *)ser_decode_uint(_value);         /*######%Cr*/
	conn = bt_rpc_decode_bt_conn(_value);                                              /*######Kdj*/
	service_data = ser_decode_uint(_value);                                            /*######@ZQ*/

	if (!ser_decoding_done_and_check(_value)) {                                        /*######%FE*/
		goto decoding_error;                                                       /*######QTM*/
	}                                                                                  /*######@1Y*/

	_result = bt_le_per_adv_sync_transfer(per_adv_sync, conn, service_data);           /*##DoYUN4k*/

	ser_rsp_send_int(_result);                                                         /*##BPC96+4*/

	return;                                                                            /*######%FY*/
decoding_error:                                                                            /*######wsp*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_TRANSFER_RPC_CMD, _handler_data);         /*######@MU*/

}                                                                                          /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_transfer, BT_LE_PER_ADV_SYNC_TRANSFER_RPC_CMD,/*####%Bh7m*/
	bt_le_per_adv_sync_transfer_rpc_handler, NULL);                                               /*#####@L+M*/

static void bt_le_per_adv_sync_transfer_unsubscribe_rpc_handler(CborValue *_value, void *_handler_data)/*####%Blxd*/
{                                                                                                      /*#####@BGE*/

	const struct bt_conn * conn;                                                                   /*####%AXkh*/
	int _result;                                                                                   /*#####@30M*/
	...
	_result = bt_le_per_adv_sync_transfer_unsubscribe(conn);                                       /*##DuybiEM*/

	ser_rsp_send_int(_result);                                                                     /*##BPC96+4*/

	return;                                                                                        /*######%Fb*/
decoding_error:                                                                                        /*######OGN*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_TRANSFER_UNSUBSCRIBE_RPC_CMD, _handler_data);         /*######@EM*/

}                                                                                                      /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_transfer_unsubscribe, BT_LE_PER_ADV_SYNC_TRANSFER_UNSUBSCRIBE_RPC_CMD,/*####%BklZ*/
	bt_le_per_adv_sync_transfer_unsubscribe_rpc_handler, NULL);                                                           /*#####@L2w*/

void bt_le_per_adv_sync_transfer_param_dec(CborValue *_value, struct bt_le_per_adv_sync_transfer_param *_data)/*####%Bgp+*/
{                                                                                                             /*#####@hlE*/

	_data->skip = ser_decode_uint(_value);                                                                /*######%Cv*/
	_data->timeout = ser_decode_uint(_value);                                                             /*######/0z*/
	_data->options = ser_decode_uint(_value);                                                             /*######@wo*/

}                                                                                                             /*##B9ELNqo*/

static void bt_le_per_adv_sync_transfer_subscribe_rpc_handler(CborValue *_value, void *_handler_data)/*####%BrHb*/
{                                                                                                    /*#####@Ozw*/

	const struct bt_conn * conn;                                                                 /*######%AU*/
	struct bt_le_per_adv_sync_transfer_param param;                                              /*######WHc*/
	int _result;                                                                                 /*######@VM*/

	conn = bt_rpc_decode_bt_conn(_value);                                                        /*####%ClGL*/
	bt_le_per_adv_sync_transfer_param_dec(_value, &param);                                       /*#####@LtI*/

	if (!ser_decoding_done_and_check(_value)) {                                                  /*######%FE*/
		goto decoding_error;                                                                 /*######QTM*/
	}                                                                                            /*######@1Y*/

	_result = bt_le_per_adv_sync_transfer_subscribe(conn, &param);                               /*##DuVAKR0*/

	ser_rsp_send_int(_result);                                                                   /*##BPC96+4*/

	return;                                                                                      /*######%FZ*/
decoding_error:                                                                                      /*######hjW*/
	report_decoding_error(BT_LE_PER_ADV_SYNC_TRANSFER_SUBSCRIBE_RPC_CMD, _handler_data);         /*######@Og*/

}                                                                                                    /*##B9ELNqo*/

NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_transfer_subscribe, BT_LE_PER_ADV_SYNC_TRANSFER_SUBSCRIBE_RPC_CMD,/*####%BhhW*/
	bt_le_per_adv_sync_transfer_subscribe_rpc_handler, NULL);                                                         /*#####@t2Q*/
#endif /* defined(CONFIG_BT_CONN) || defined(__GENERATOR) */

size_t bt_le_per_adv_sync_synced_info_sp_size(const struct bt_le_per_adv_sync_synced_info *_data)/*####%BnwU*/
{                                                                                                /*#####@/J0*/
...
size_t bt_le_per_adv_sync_synced_info_buf_size(const struct bt_le_per_adv_sync_synced_info *_data)/*####%Btdo*/
{                                                                                                 /*#####@RNw*/

	size_t _buffer_size_max = 17;                                                             /*##AQTL2Io*/
...
void bt_le_per_adv_sync_synced_info_enc(CborEncoder *_encoder, const struct bt_le_per_adv_sync_synced_info *_data)/*####%Bj/b*/
{                                                                                                                 /*#####@W7A*/

	SERIALIZE(STRUCT(struct bt_le_per_adv_sync_synced_info));

	ser_encode_buffer(_encoder, _data->addr, sizeof(bt_addr_le_t));                                           /*#######%A*/
	ser_encode_uint(_encoder, _data->sid);                                                                    /*#######5L*/
	ser_encode_uint(_encoder, _data->interval);                                                               /*########C*/
	ser_encode_uint(_encoder, _data->phy);                                                                    /*########P*/
	ser_encode_bool(_encoder, _data->recv_enabled);                                                           /*########S*/
	ser_encode_uint(_encoder, _data->service_data);                                                           /*########Y*/
			    ...
			    struct bt_le_per_adv_sync_synced_info *info)
{
	...
	size_t _scratchpad_size = 0;                                             /*######DkW*/
	size_t _buffer_size_max = 10;                                            /*######@Dc*/

	_buffer_size_max += bt_le_per_adv_sync_synced_info_buf_size(info);       /*##CM1N51g*/

	_scratchpad_size += bt_le_per_adv_sync_synced_info_sp_size(info);        /*##EBUObWc*/

	NRF_RPC_CBOR_ALLOC(_ctx, _buffer_size_max);                              /*####%AoDN*/
	ser_encode_uint(&_ctx.encoder, _scratchpad_size);                        /*#####@BNc*/

	ser_encode_uint(&_ctx.encoder, (uintptr_t)sync);                         /*####%A8cd*/
	bt_le_per_adv_sync_synced_info_enc(&_ctx.encoder, info);                 /*#####@Fzk*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, PER_ADV_SYNC_CB_SYNCED_RPC_CMD,     /*####%BEdB*/
		&_ctx, ser_rsp_decode_void, NULL);                               /*#####@soY*/
}

size_t bt_le_per_adv_sync_term_info_sp_size(const struct bt_le_per_adv_sync_term_info *_data)/*####%BiPQ*/
{                                                                                            /*#####@D04*/
...
size_t bt_le_per_adv_sync_term_info_buf_size(const struct bt_le_per_adv_sync_term_info *_data)/*####%BnOl*/
{                                                                                             /*#####@ocs*/

	size_t _buffer_size_max = 5;                                                          /*##AeSjJCw*/
...
void bt_le_per_adv_sync_term_info_enc(CborEncoder *_encoder, const struct bt_le_per_adv_sync_term_info *_data)/*####%Bqyi*/
{                                                                                                             /*#####@Apk*/

	SERIALIZE(STRUCT(struct bt_le_per_adv_sync_term_info));

	ser_encode_buffer(_encoder, _data->addr, sizeof(bt_addr_le_t));                                       /*####%A6y5*/
	ser_encode_uint(_encoder, _data->sid);                                                                /*#####@hf0*/
			  ...
			  const struct bt_le_per_adv_sync_term_info *info)
{
	...
	_buffer_size_max += bt_le_per_adv_sync_term_info_buf_size(info);         /*##CF4Lt70*/

	_scratchpad_size += bt_le_per_adv_sync_term_info_sp_size(info);          /*##EG89B5w*/

	NRF_RPC_CBOR_ALLOC(_ctx, _buffer_size_max);                              /*####%AoDN*/
	ser_encode_uint(&_ctx.encoder, _scratchpad_size);                        /*#####@BNc*/

	ser_encode_uint(&_ctx.encoder, (uintptr_t)sync);                         /*####%AzGl*/
	bt_le_per_adv_sync_term_info_enc(&_ctx.encoder, info);                   /*#####@QnI*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, PER_ADV_SYNC_CB_TERM_RPC_CMD,       /*####%BMDI*/
		&_ctx, ser_rsp_decode_void, NULL);                               /*#####@ysQ*/
}

size_t bt_le_per_adv_sync_recv_info_sp_size(const struct bt_le_per_adv_sync_recv_info *_data)/*####%Bjxe*/
{                                                                                            /*#####@huQ*/
...
size_t bt_le_per_adv_sync_recv_info_buf_size(const struct bt_le_per_adv_sync_recv_info *_data)/*####%Buk7*/
{                                                                                             /*#####@Izo*/

	size_t _buffer_size_max = 11;                                                         /*##ARIbU74*/
...
void bt_le_per_adv_sync_recv_info_enc(CborEncoder *_encoder, const struct bt_le_per_adv_sync_recv_info *_data)/*####%BveQ*/
{                                                                                                             /*#####@wJ0*/

	SERIALIZE(STRUCT(struct bt_le_per_adv_sync_recv_info));

	ser_encode_buffer(_encoder, _data->addr, sizeof(bt_addr_le_t));                                       /*#######%A*/
	ser_encode_uint(_encoder, _data->sid);                                                                /*#######xZ*/
	ser_encode_int(_encoder, _data->tx_power);                                                            /*#######m4*/
	ser_encode_int(_encoder, _data->rssi);                                                                /*#######rQ*/
			  ...
			  struct net_buf_simple *buf)
{
	...
	_buffer_size_max += bt_le_per_adv_sync_recv_info_buf_size(info);         /*####%CGIU*/
	_buffer_size_max += net_buf_simple_buf_size(buf);                        /*#####@34I*/

	_scratchpad_size += bt_le_per_adv_sync_recv_info_sp_size(info);          /*####%EDPY*/
	_scratchpad_size += net_buf_simple_sp_size(buf);                         /*#####@yHo*/

	NRF_RPC_CBOR_ALLOC(_ctx, _buffer_size_max);                              /*####%AoDN*/
	ser_encode_uint(&_ctx.encoder, _scratchpad_size);                        /*#####@BNc*/

	ser_encode_uint(&_ctx.encoder, (uintptr_t)sync);                         /*######%A9*/
	bt_le_per_adv_sync_recv_info_enc(&_ctx.encoder, info);                   /*######isI*/
	net_buf_simple_enc(&_ctx.encoder, buf);                                  /*######@n8*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, PER_ADV_SYNC_CB_RECV_RPC_CMD,       /*####%BHd1*/
		&_ctx, ser_rsp_decode_void, NULL);                               /*#####@8Kc*/
}

UNUSED
static const size_t bt_le_per_adv_sync_state_info_buf_size = 1;                  /*##BiiQsRQ*/

void bt_le_per_adv_sync_state_info_enc(CborEncoder *_encoder, const struct bt_le_per_adv_sync_state_info *_data)/*####%BuVG*/
{                                                                                                               /*#####@QaU*/

	SERIALIZE(STRUCT(struct bt_le_per_adv_sync_state_info));

	ser_encode_bool(_encoder, _data->recv_enabled);                                                         /*##AyPxwxk*/
				   ...
				   const struct bt_le_per_adv_sync_state_info *info)
{
	...
	ser_encode_uint(&_ctx.encoder, (uintptr_t)sync);                           /*####%A4ml*/
	bt_le_per_adv_sync_state_info_enc(&_ctx.encoder, info);                    /*#####@WSw*/

	nrf_rpc_cbor_cmd_no_err(&bt_rpc_grp, PER_ADV_SYNC_CB_STATE_CHANGED_RPC_CMD,/*####%BBTD*/
		&_ctx, ser_rsp_decode_void, NULL);                                 /*#####@Fb4*/
}
...
static void bt_le_per_adv_sync_cb_register_on_remote_rpc_handler(CborValue *_value, void *_handler_data)/*####%BrD0*/
{                                                                                                       /*#####@b5M*/
...
NRF_RPC_CBOR_CMD_DECODER(bt_rpc_grp, bt_le_per_adv_sync_cb_register_on_remote, BT_LE_PER_ADV_SYNC_CB_REGISTER_ON_REMOTE_RPC_CMD,/*####%Bru1*/
	bt_le_per_adv_sync_cb_register_on_remote_rpc_handler, NULL);                                                            /*#####@hO0*/
